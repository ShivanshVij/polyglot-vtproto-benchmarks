...
func (x *IntegerData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IntegerData) ProtoMessage() {}

func (x *IntegerData) ProtoReflect() protoreflect.Message {
	mi := &file_bench_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IntegerData.ProtoReflect.Descriptor instead.
func (*IntegerData) Descriptor() ([]byte, []int) {
	return file_bench_proto_rawDescGZIP(), []int{1}
}

func (x *IntegerData) GetInteger() int32 {
	if x != nil {
		return x.Integer
	}
	return 0
...
var file_bench_proto_rawDesc = []byte{
	...
	0x22, 0x27, 0x0a, 0x0b, 0x49, 0x6e, 0x74, 0x65, 0x67, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x18, 0x0a, 0x07, 0x69, 0x6e, 0x74, 0x65, 0x67, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x07, 0x69, 0x6e, 0x74, 0x65, 0x67, 0x65, 0x72, 0x32, 0x0b, 0x0a, 0x09, 0x42, 0x65, 0x6e,
	0x63, 0x68, 0x6d, 0x61, 0x72, 0x6b, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f, 0x62, 0x65, 0x6e, 0x63,
